...
{
    public class GenericSegurancaRepository<TEntity> : IGenericSegurancaRepository<TEntity> where TEntity: IdentityUser
    {
        private readonly SegurancaDbContext context;

        public GenericSegurancaRepository(SegurancaDbContext context)
        {
        ...
        {
            return SegurancaSpecificationEvaluator<TEntity>.GetQuery(context.Set<TEntity>().AsQueryable(), spec);
        }
